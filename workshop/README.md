以下の3つのハンズオンを実施してください。

- [Lab 1](Lab1): Kubernetesクラスターにアプリケーションをデプロイします

- [Lab 2](Lab2): アプリケーションのスケーリングやアップデートを実施します

- [Lab 3](Lab3): K8sの構成ファイル(マニフェストファイル)を使用して，アプリケーションのデプロイなどの操作を行います
